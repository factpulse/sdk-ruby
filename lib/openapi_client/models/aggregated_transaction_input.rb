...
module OpenapiClient
  ...
  class AggregatedTransactionInput < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AggregatedTransactionInput` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AggregatedTransactionInput`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tax_due_type')
        self.tax_due_type = attributes[:'tax_due_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @category_code.nil?
        invalid_properties.push('invalid value for "category_code", category_code cannot be nil.')
      end
      ...
      if !@transaction_count.nil? && @transaction_count < 1
        invalid_properties.push('invalid value for "transaction_count", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@transaction_count.nil? && @transaction_count < 1
      true
    end
    ...
    def category_code=(category_code)
      if category_code.nil?
        fail ArgumentError, 'category_code cannot be nil'
      end
    ...
    def transaction_count=(transaction_count)
      if !transaction_count.nil? && transaction_count < 1
        fail ArgumentError, 'invalid value for "transaction_count", must be greater than or equal to 1.'
      end
    ...
    def hash
      [date, category_code, currency, tax_exclusive_amount, tax_amount, tax_breakdown, transaction_count, tax_due_type].hash
    end
