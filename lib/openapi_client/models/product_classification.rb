...
module OpenapiClient
  ...
  class ProductClassification < ApiModelBase
    # Classification code (BT-158).
    attr_accessor :class_code

    attr_accessor :list_id

    attr_accessor :list_version_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ProductClassification` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ProductClassification`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'list_version_id')
        self.list_version_id = attributes[:'list_version_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          list_id == o.list_id &&
          list_version_id == o.list_version_id
    end
    ...
    def hash
      [class_code, list_id, list_version_id].hash
    end
