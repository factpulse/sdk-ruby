  ...
  class AFNORSearchFlowFilters < ApiModelBase
    ...
    def self.openapi_types
      {
        :'updated_after' => :'Time',
        :'updated_before' => :'Time',
        :'processing_rule' => :'Array<AFNORProcessingRule>',
        :'flow_type' => :'Array<AFNORFlowType>',
        :'flow_direction' => :'Array<AFNORFlowDirection>',
        :'tracking_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AFNORSearchFlowFilters` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AFNORSearchFlowFilters`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'processing_rule')
        if (value = attributes[:'processing_rule']).is_a?(Array)
          self.processing_rule = value
        end
      end

      if attributes.key?(:'flow_type')
        if (value = attributes[:'flow_type']).is_a?(Array)
          self.flow_type = value
        end
      end

      if attributes.key?(:'flow_direction')
        if (value = attributes[:'flow_direction']).is_a?(Array)
    ...
    def hash
      [updated_after, updated_before, processing_rule, flow_type, flow_direction, tracking_id, ack_status].hash
    end
