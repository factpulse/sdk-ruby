...
module OpenapiClient
  ...
  class Recipient < ApiModelBase
    ...
    attr_accessor :executing_service_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Recipient` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Recipient`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'executing_service_code')
        self.executing_service_code = attributes[:'executing_service_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          executing_service_code == o.executing_service_code &&
          name == o.name &&
          siren == o.siren &&
          siret == o.siret &&
    ...
    def hash
      [electronic_address, executing_service_code, name, siren, siret, vat_number, postal_address, contact, global_ids].hash
    end
