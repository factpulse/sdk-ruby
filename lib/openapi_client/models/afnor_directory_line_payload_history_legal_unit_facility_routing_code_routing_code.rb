...
module OpenapiClient
  class AFNORDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode < ApiModelBase
    ...
    attr_accessor :manages_legal_commitment
    ...
    def self.openapi_types
      {
        ...
        :'manages_legal_commitment' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AFNORDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AFNORDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'manages_legal_commitment')
        self.manages_legal_commitment = attributes[:'manages_legal_commitment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          manages_legal_commitment == o.manages_legal_commitment &&
    ...
    def hash
      [routing_identifier, routing_identifier_type, routing_code_name, manages_legal_commitment, administrative_status, address].hash
    end
