...
module OpenapiClient
  ...
  class AFNORAddressRead < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AFNORAddressRead` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AFNORAddressRead`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def address_line2=(address_line2)
      ...
      if address_line2.to_s.length > 255
    ...
    def address_line3=(address_line3)
      ...
      if address_line3.to_s.length > 255
    ...
    def country_name=(country_name)
      ...
      if country_name.to_s.length > 100
        fail ArgumentError, 'invalid value for "country_name", the character length must be smaller than or equal to 100.'
      end
