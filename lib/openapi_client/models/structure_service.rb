...
module OpenapiClient
  # Structure service.
  class StructureService < ApiModelBase
    # Service ID
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::StructureService` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::StructureService`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_label')
        self.service_label = attributes[:'service_label']
      else
        self.service_label = nil
      end
    ...
    def list_invalid_properties
      ...
      if @service_label.nil?
        invalid_properties.push('invalid value for "service_label", service_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_label.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] service_label Value to be assigned
    def service_label=(service_label)
      if service_label.nil?
        fail ArgumentError, 'service_label cannot be nil'
      end
    ...
    def hash
      [service_id, service_code, service_label, is_active].hash
    end
