...
module OpenapiClient
  ...
  class CreateAggregatedReportRequest < ApiModelBase
    ...
    attr_accessor :transaction_payments
    ...
    def self.openapi_types
      {
        ...
        :'transaction_payments' => :'Array<AggregatedPaymentInput>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CreateAggregatedReportRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CreateAggregatedReportRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_payments')
        if (value = attributes[:'transaction_payments']).is_a?(Array)
          self.transaction_payments = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transaction_payments == o.transaction_payments
    end
    ...
    def hash
      [report_id, report_name, transmission_type, sender, period, invoices, transactions, invoice_payments, transaction_payments].hash
    end
