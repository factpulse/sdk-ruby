...
module FactPulse
  class AFNORDirectoryLineField
    ADDRESSING_IDENTIFIER = "addressingIdentifier".freeze
    SIREN = "siren".freeze
    SIRET = "siret".freeze
    ...
    def build_from_hash(value)
      return value if AFNORDirectoryLineField.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AFNORDirectoryLineField"
    end
  end
end
