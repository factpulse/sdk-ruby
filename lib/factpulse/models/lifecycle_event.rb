...
module FactPulse
  ...
  class LifecycleEvent < ApiModelBase
    ...
    attr_accessor :issuer_siren

    attr_accessor :issuer_role
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FactPulse::LifecycleEvent` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FactPulse::LifecycleEvent`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issuer_siren')
        self.issuer_siren = attributes[:'issuer_siren']
      end

      if attributes.key?(:'issuer_role')
        self.issuer_role = attributes[:'issuer_role']
      end
    ...
    def valid?
      ...
      return false if !@amount.nil? && @amount !~ Regexp.new(/^(?!^[-+.]*$)[+-]?0*\d*\.?\d*$/)
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          currency == o.currency &&
          issuer_siren == o.issuer_siren &&
          issuer_role == o.issuer_role &&
    ...
    def hash
      [flow_id, status_code, status_description, ack_status, at, document_id, amount, currency, issuer_siren, issuer_role, reason_code].hash
    end
