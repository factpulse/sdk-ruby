...
module FactPulse
  class TaxDueDateType
    ...
    def self.all_vars
      @all_vars ||= [N5, N29, N72, N3, N35, N432].freeze
    end
    ...
    def build_from_hash(value)
      return value if TaxDueDateType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TaxDueDateType"
    end
  end
end
