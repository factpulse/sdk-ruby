...
module FactPulse
  class CodeCadreFacturation
    A1_FACTURE_FOURNISSEUR = "A1_FACTURE_FOURNISSEUR".freeze
    ...
    def build_from_hash(value)
      return value if CodeCadreFacturation.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CodeCadreFacturation"
    end
  end
end
