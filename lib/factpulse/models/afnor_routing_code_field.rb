...
module FactPulse
  class AFNORRoutingCodeField
    SIRET = "siret".freeze
    ROUTING_IDENTIFIER_TYPE = "routingIdentifierType".freeze
    ROUTING_CODE_NAME = "routingCodeName".freeze
    ...
    def build_from_hash(value)
      return value if AFNORRoutingCodeField.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AFNORRoutingCodeField"
    end
  end
end
