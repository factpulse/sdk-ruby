...
module FactPulse
  ...
  class VerificationSuccessTaskResult < ApiModelBase
    ...
    def self.openapi_types
      {
        :'status' => :'String',
        :'verification_result' => :'VerificationSuccessResponse'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FactPulse::VerificationSuccessTaskResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FactPulse::VerificationSuccessTaskResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @verification_result.nil?
        invalid_properties.push('invalid value for "verification_result", verification_result cannot be nil.')
      end
    ...
    # @param [Object] verification_result Value to be assigned
    def verification_result=(verification_result)
      if verification_result.nil?
        fail ArgumentError, 'verification_result cannot be nil'
      end
    ...
    def hash
      [status, verification_result].hash
    end
