...
module FactPulse
  ...
  class SoumettreFactureCompleteResponse < ApiModelBase
    # La facture a été soumise avec succès
    attr_accessor :succes

    # Type de destination
    attr_accessor :destination_type

    attr_accessor :resultat_chorus

    attr_accessor :resultat_afnor

    # Données de la facture enrichie
    attr_accessor :facture_enrichie

    # Informations sur le PDF généré
    attr_accessor :pdf_facturx
    ...
    # @param [Object] succes Value to be assigned
    def succes=(succes)
      if succes.nil?
        fail ArgumentError, 'succes cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] facture_enrichie Value to be assigned
    def facture_enrichie=(facture_enrichie)
      if facture_enrichie.nil?
        fail ArgumentError, 'facture_enrichie cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pdf_facturx Value to be assigned
    def pdf_facturx=(pdf_facturx)
      if pdf_facturx.nil?
        fail ArgumentError, 'pdf_facturx cannot be nil'
      end
