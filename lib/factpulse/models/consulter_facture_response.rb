...
module FactPulse
  ...
  class ConsulterFactureResponse < ApiModelBase
    ...
    attr_accessor :statut_courant

    attr_accessor :id_structure_cpp_destinataire

    attr_accessor :designation_structure_destinataire
