...
module FactPulse
  ...
  class ConversionValidationFailedResult < ApiModelBase
    ...
    attr_accessor :correction_attempted
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FactPulse::ConversionValidationFailedResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FactPulse::ConversionValidationFailedResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'correction_attempted')
        self.correction_attempted = attributes[:'correction_attempted']
      else
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["VALIDATION_FAILED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["VALIDATION_FAILED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          correction_attempted == o.correction_attempted
    end
    ...
    def hash
      [status, conversion_id, message, extracted_data, extraction, validation_errors, profile, processing_time_ms, correction_attempted].hash
    end
