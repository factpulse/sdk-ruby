...
module FactPulse
  class AFNORContainsOrStrictOperator
    CONTAINS = "contains".freeze
    STRICT = "strict".freeze

    def self.all_vars
      @all_vars ||= [CONTAINS, STRICT].freeze
    end
    ...
    def build_from_hash(value)
      return value if AFNORContainsOrStrictOperator.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AFNORContainsOrStrictOperator"
    end
  end
end
