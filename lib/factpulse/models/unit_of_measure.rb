...
module FactPulse
  class UnitOfMeasure
    ...
    def self.all_vars
      @all_vars ||= [PIECE, HEURE, JOUR, KILOGRAMME, LITRE, FORFAIT, C62, H87, HUR, DAY, MON, MIN, KGM, LTR, MTR, MTK, TNE, KWH, SET, LS].freeze
    end
    ...
    def build_from_hash(value)
      return value if UnitOfMeasure.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #UnitOfMeasure"
    end
  end
end
