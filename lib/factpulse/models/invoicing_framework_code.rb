...
module FactPulse
  class InvoicingFrameworkCode
    ...
    def build_from_hash(value)
      return value if InvoicingFrameworkCode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InvoicingFrameworkCode"
    end
  end
end
