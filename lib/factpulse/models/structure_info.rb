...
module FactPulse
  ...
  class StructureInfo < ApiModelBase
    ...
    # Type d'identifiant
    attr_accessor :type_identifiant_structure
    ...
    def self.openapi_types
      {
        ...
        :'type_identifiant_structure' => :'String',
        :'statut' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FactPulse::StructureInfo` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FactPulse::StructureInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'designation_structure')
        ...
        self.designation_structure = nil
      end

      if attributes.key?(:'type_identifiant_structure')
        self.type_identifiant_structure = attributes[:'type_identifiant_structure']
      else
        self.type_identifiant_structure = nil
      end
    ...
    def list_invalid_properties
      ...
      if @designation_structure.nil?
        invalid_properties.push('invalid value for "designation_structure", designation_structure cannot be nil.')
      end

      if @type_identifiant_structure.nil?
        invalid_properties.push('invalid value for "type_identifiant_structure", type_identifiant_structure cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @designation_structure.nil?
      return false if @type_identifiant_structure.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] designation_structure Value to be assigned
    def designation_structure=(designation_structure)
      if designation_structure.nil?
        fail ArgumentError, 'designation_structure cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] type_identifiant_structure Value to be assigned
    def type_identifiant_structure=(type_identifiant_structure)
      if type_identifiant_structure.nil?
        fail ArgumentError, 'type_identifiant_structure cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type_identifiant_structure == o.type_identifiant_structure &&
          statut == o.statut
    end
    ...
    def hash
      [id_structure_cpp, identifiant_structure, designation_structure, type_identifiant_structure, statut].hash
    end
