...
# Unit tests for FactPulse::PostalAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::PostalAddress do
  #let(:instance) { FactPulse::PostalAddress.new }

  describe 'test an instance of PostalAddress' do
    it 'should create an instance of PostalAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::PostalAddress)
    end
  end
