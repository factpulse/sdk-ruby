...
# Unit tests for FactPulse::AFNORPlatformStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORPlatformStatus do
  #let(:instance) { FactPulse::AFNORPlatformStatus.new }

  describe 'test an instance of AFNORPlatformStatus' do
    it 'should create an instance of AFNORPlatformStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORPlatformStatus)
    end
  end
