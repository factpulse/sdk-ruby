...
# Unit tests for FactPulse::SignatureSuccessResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::SignatureSuccessResult do
  #let(:instance) { FactPulse::SignatureSuccessResult.new }

  describe 'test an instance of SignatureSuccessResult' do
    it 'should create an instance of SignatureSuccessResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::SignatureSuccessResult)
    end
  end
  ...
  describe 'test attribute "signer_cn"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "signing_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
