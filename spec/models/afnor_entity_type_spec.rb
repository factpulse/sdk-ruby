...
# Unit tests for FactPulse::AFNOREntityType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNOREntityType do
  #let(:instance) { FactPulse::AFNOREntityType.new }

  describe 'test an instance of AFNOREntityType' do
    it 'should create an instance of AFNOREntityType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNOREntityType)
    end
  end
