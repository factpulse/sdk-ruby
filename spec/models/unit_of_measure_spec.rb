...
# Unit tests for FactPulse::UnitOfMeasure
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::UnitOfMeasure do
  #let(:instance) { FactPulse::UnitOfMeasure.new }

  describe 'test an instance of UnitOfMeasure' do
    it 'should create an instance of UnitOfMeasure' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::UnitOfMeasure)
    end
  end
