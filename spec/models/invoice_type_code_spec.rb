...
# Unit tests for FactPulse::InvoiceTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::InvoiceTypeCode do
  #let(:instance) { FactPulse::InvoiceTypeCode.new }

  describe 'test an instance of InvoiceTypeCode' do
    it 'should create an instance of InvoiceTypeCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::InvoiceTypeCode)
    end
  end
