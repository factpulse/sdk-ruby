...
# Unit tests for FactPulse::ValidationTaskStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ValidationTaskStatus do
  #let(:instance) { FactPulse::ValidationTaskStatus.new }

  describe 'test an instance of ValidationTaskStatus' do
    it 'should create an instance of ValidationTaskStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ValidationTaskStatus)
    end
  end
