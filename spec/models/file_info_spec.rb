...
# Unit tests for FactPulse::FileInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::FileInfo do
  #let(:instance) { FactPulse::FileInfo.new }

  describe 'test an instance of FileInfo' do
    it 'should create an instance of FileInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::FileInfo)
    end
  end
