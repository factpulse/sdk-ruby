...
# Unit tests for FactPulse::VATEXCodeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::VATEXCodeInfo do
  #let(:instance) { FactPulse::VATEXCodeInfo.new }

  describe 'test an instance of VATEXCodeInfo' do
    it 'should create an instance of VATEXCodeInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::VATEXCodeInfo)
    end
  end
