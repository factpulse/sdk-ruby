...
# Unit tests for FactPulse::VerificationTypedTaskStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::VerificationTypedTaskStatus do
  #let(:instance) { FactPulse::VerificationTypedTaskStatus.new }

  describe 'test an instance of VerificationTypedTaskStatus' do
    it 'should create an instance of VerificationTypedTaskStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::VerificationTypedTaskStatus)
    end
  end
