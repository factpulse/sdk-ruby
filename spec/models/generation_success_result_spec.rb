...
# Unit tests for FactPulse::GenerationSuccessResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::GenerationSuccessResult do
  #let(:instance) { FactPulse::GenerationSuccessResult.new }

  describe 'test an instance of GenerationSuccessResult' do
    it 'should create an instance of GenerationSuccessResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::GenerationSuccessResult)
    end
  end
