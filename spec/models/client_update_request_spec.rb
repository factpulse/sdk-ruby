...
# Unit tests for FactPulse::ClientUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ClientUpdateRequest do
  #let(:instance) { FactPulse::ClientUpdateRequest.new }

  describe 'test an instance of ClientUpdateRequest' do
    it 'should create an instance of ClientUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ClientUpdateRequest)
    end
  end
