...
# Unit tests for FactPulse::ConversionErrorResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ConversionErrorResult do
  #let(:instance) { FactPulse::ConversionErrorResult.new }

  describe 'test an instance of ConversionErrorResult' do
    it 'should create an instance of ConversionErrorResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ConversionErrorResult)
    end
  end
