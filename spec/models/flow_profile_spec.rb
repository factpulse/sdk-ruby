...
# Unit tests for FactPulse::FlowProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::FlowProfile do
  #let(:instance) { FactPulse::FlowProfile.new }

  describe 'test an instance of FlowProfile' do
    it 'should create an instance of FlowProfile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::FlowProfile)
    end
  end
