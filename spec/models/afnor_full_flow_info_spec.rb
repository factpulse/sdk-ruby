...
# Unit tests for FactPulse::AFNORFullFlowInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFullFlowInfo do
  #let(:instance) { FactPulse::AFNORFullFlowInfo.new }

  describe 'test an instance of AFNORFullFlowInfo' do
    it 'should create an instance of AFNORFullFlowInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFullFlowInfo)
    end
  end
