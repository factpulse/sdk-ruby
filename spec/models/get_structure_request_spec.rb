...
# Unit tests for FactPulse::GetStructureRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::GetStructureRequest do
  #let(:instance) { FactPulse::GetStructureRequest.new }

  describe 'test an instance of GetStructureRequest' do
    it 'should create an instance of GetStructureRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::GetStructureRequest)
    end
  end
