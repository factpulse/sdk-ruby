...
# Unit tests for FactPulse::AFNORCallbackParameters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORCallbackParameters do
  #let(:instance) { FactPulse::AFNORCallbackParameters.new }

  describe 'test an instance of AFNORCallbackParameters' do
    it 'should create an instance of AFNORCallbackParameters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORCallbackParameters)
    end
  end
