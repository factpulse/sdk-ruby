...
# Unit tests for FactPulse::AFNORFacilityNature
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFacilityNature do
  #let(:instance) { FactPulse::AFNORFacilityNature.new }

  describe 'test an instance of AFNORFacilityNature' do
    it 'should create an instance of AFNORFacilityNature' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFacilityNature)
    end
  end
