...
# Unit tests for FactPulse::AFNORDirectoryLineStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORDirectoryLineStatus do
  #let(:instance) { FactPulse::AFNORDirectoryLineStatus.new }

  describe 'test an instance of AFNORDirectoryLineStatus' do
    it 'should create an instance of AFNORDirectoryLineStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORDirectoryLineStatus)
    end
  end
