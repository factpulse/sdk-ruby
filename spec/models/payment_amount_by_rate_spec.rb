...
# Unit tests for FactPulse::PaymentAmountByRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::PaymentAmountByRate do
  #let(:instance) { FactPulse::PaymentAmountByRate.new }

  describe 'test an instance of PaymentAmountByRate' do
    it 'should create an instance of PaymentAmountByRate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::PaymentAmountByRate)
    end
  end
