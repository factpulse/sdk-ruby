...
# Unit tests for FactPulse::AFNORSearchFlowFilters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORSearchFlowFilters do
  #let(:instance) { FactPulse::AFNORSearchFlowFilters.new }

  describe 'test an instance of AFNORSearchFlowFilters' do
    it 'should create an instance of AFNORSearchFlowFilters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORSearchFlowFilters)
    end
  end
