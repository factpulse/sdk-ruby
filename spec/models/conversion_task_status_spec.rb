...
# Unit tests for FactPulse::ConversionTaskStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ConversionTaskStatus do
  #let(:instance) { FactPulse::ConversionTaskStatus.new }

  describe 'test an instance of ConversionTaskStatus' do
    it 'should create an instance of ConversionTaskStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ConversionTaskStatus)
    end
  end
