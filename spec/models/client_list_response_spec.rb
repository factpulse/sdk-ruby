...
# Unit tests for FactPulse::ClientListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ClientListResponse do
  #let(:instance) { FactPulse::ClientListResponse.new }

  describe 'test an instance of ClientListResponse' do
    it 'should create an instance of ClientListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ClientListResponse)
    end
  end
