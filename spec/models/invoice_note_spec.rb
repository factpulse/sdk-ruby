...
# Unit tests for FactPulse::InvoiceNote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::InvoiceNote do
  #let(:instance) { FactPulse::InvoiceNote.new }

  describe 'test an instance of InvoiceNote' do
    it 'should create an instance of InvoiceNote' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::InvoiceNote)
    end
  end
