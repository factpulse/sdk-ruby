...
# Unit tests for FactPulse::AFNORErrorDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORErrorDetail do
  #let(:instance) { FactPulse::AFNORErrorDetail.new }

  describe 'test an instance of AFNORErrorDetail' do
    it 'should create an instance of AFNORErrorDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORErrorDetail)
    end
  end
