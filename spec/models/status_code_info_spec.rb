...
# Unit tests for FactPulse::StatusCodeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::StatusCodeInfo do
  #let(:instance) { FactPulse::StatusCodeInfo.new }

  describe 'test an instance of StatusCodeInfo' do
    it 'should create an instance of StatusCodeInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::StatusCodeInfo)
    end
  end
