...
# Unit tests for FactPulse::TransactionCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::TransactionCategory do
  #let(:instance) { FactPulse::TransactionCategory.new }

  describe 'test an instance of TransactionCategory' do
    it 'should create an instance of TransactionCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::TransactionCategory)
    end
  end
