...
# Unit tests for FactPulse::AFNORCallbackHeader
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORCallbackHeader do
  #let(:instance) { FactPulse::AFNORCallbackHeader.new }

  describe 'test an instance of AFNORCallbackHeader' do
    it 'should create an instance of AFNORCallbackHeader' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORCallbackHeader)
    end
  end
