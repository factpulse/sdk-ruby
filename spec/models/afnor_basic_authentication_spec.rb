...
# Unit tests for FactPulse::AFNORBasicAuthentication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORBasicAuthentication do
  #let(:instance) { FactPulse::AFNORBasicAuthentication.new }

  describe 'test an instance of AFNORBasicAuthentication' do
    it 'should create an instance of AFNORBasicAuthentication' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORBasicAuthentication)
    end
  end
