...
# Unit tests for FactPulse::ClientSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ClientSummary do
  #let(:instance) { FactPulse::ClientSummary.new }

  describe 'test an instance of ClientSummary' do
    it 'should create an instance of ClientSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ClientSummary)
    end
  end
