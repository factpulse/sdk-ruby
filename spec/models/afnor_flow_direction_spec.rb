...
# Unit tests for FactPulse::AFNORFlowDirection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFlowDirection do
  #let(:instance) { FactPulse::AFNORFlowDirection.new }

  describe 'test an instance of AFNORFlowDirection' do
    it 'should create an instance of AFNORFlowDirection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFlowDirection)
    end
  end
