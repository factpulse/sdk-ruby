...
# Unit tests for FactPulse::AFNORError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORError do
  #let(:instance) { FactPulse::AFNORError.new }

  describe 'test an instance of AFNORError' do
    it 'should create an instance of AFNORError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORError)
    end
  end
