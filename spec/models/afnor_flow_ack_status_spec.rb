...
# Unit tests for FactPulse::AFNORFlowAckStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFlowAckStatus do
  #let(:instance) { FactPulse::AFNORFlowAckStatus.new }

  describe 'test an instance of AFNORFlowAckStatus' do
    it 'should create an instance of AFNORFlowAckStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFlowAckStatus)
    end
  end
