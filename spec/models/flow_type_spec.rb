...
# Unit tests for FactPulse::FlowType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::FlowType do
  #let(:instance) { FactPulse::FlowType.new }

  describe 'test an instance of FlowType' do
    it 'should create an instance of FlowType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::FlowType)
    end
  end
