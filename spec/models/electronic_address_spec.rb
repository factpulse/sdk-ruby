...
# Unit tests for FactPulse::ElectronicAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ElectronicAddress do
  #let(:instance) { FactPulse::ElectronicAddress.new }

  describe 'test an instance of ElectronicAddress' do
    it 'should create an instance of ElectronicAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ElectronicAddress)
    end
  end
