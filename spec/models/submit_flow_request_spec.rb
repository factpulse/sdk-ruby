...
# Unit tests for FactPulse::SubmitFlowRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::SubmitFlowRequest do
  #let(:instance) { FactPulse::SubmitFlowRequest.new }

  describe 'test an instance of SubmitFlowRequest' do
    it 'should create an instance of SubmitFlowRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::SubmitFlowRequest)
    end
  end
