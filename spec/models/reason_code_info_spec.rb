...
# Unit tests for FactPulse::ReasonCodeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ReasonCodeInfo do
  #let(:instance) { FactPulse::ReasonCodeInfo.new }

  describe 'test an instance of ReasonCodeInfo' do
    it 'should create an instance of ReasonCodeInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ReasonCodeInfo)
    end
  end
