...
# Unit tests for FactPulse::FacturXPDFInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::FacturXPDFInfo do
  #let(:instance) { FactPulse::FacturXPDFInfo.new }

  describe 'test an instance of FacturXPDFInfo' do
    it 'should create an instance of FacturXPDFInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::FacturXPDFInfo)
    end
  end
