...
# Unit tests for FactPulse::LifecycleResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::LifecycleResponse do
  #let(:instance) { FactPulse::LifecycleResponse.new }

  describe 'test an instance of LifecycleResponse' do
    it 'should create an instance of LifecycleResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::LifecycleResponse)
    end
  end
  ...
  describe 'test attribute "cutoff_days"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
