...
# Unit tests for FactPulse::AFNORFlowInfoExtension
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFlowInfoExtension do
  #let(:instance) { FactPulse::AFNORFlowInfoExtension.new }

  describe 'test an instance of AFNORFlowInfoExtension' do
    it 'should create an instance of AFNORFlowInfoExtension' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFlowInfoExtension)
    end
  end
