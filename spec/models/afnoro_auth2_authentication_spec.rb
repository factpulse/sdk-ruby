...
# Unit tests for FactPulse::AFNOROAuth2Authentication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNOROAuth2Authentication do
  #let(:instance) { FactPulse::AFNOROAuth2Authentication.new }

  describe 'test an instance of AFNOROAuth2Authentication' do
    it 'should create an instance of AFNOROAuth2Authentication' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNOROAuth2Authentication)
    end
  end
