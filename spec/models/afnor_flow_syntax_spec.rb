...
# Unit tests for FactPulse::AFNORFlowSyntax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFlowSyntax do
  #let(:instance) { FactPulse::AFNORFlowSyntax.new }

  describe 'test an instance of AFNORFlowSyntax' do
    it 'should create an instance of AFNORFlowSyntax' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFlowSyntax)
    end
  end
