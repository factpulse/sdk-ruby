...
# Unit tests for FactPulse::AFNORReasonCodeEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORReasonCodeEnum do
  #let(:instance) { FactPulse::AFNORReasonCodeEnum.new }

  describe 'test an instance of AFNORReasonCodeEnum' do
    it 'should create an instance of AFNORReasonCodeEnum' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORReasonCodeEnum)
    end
  end
