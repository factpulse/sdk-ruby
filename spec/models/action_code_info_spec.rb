...
# Unit tests for FactPulse::ActionCodeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ActionCodeInfo do
  #let(:instance) { FactPulse::ActionCodeInfo.new }

  describe 'test an instance of ActionCodeInfo' do
    it 'should create an instance of ActionCodeInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ActionCodeInfo)
    end
  end
