...
# Unit tests for FactPulse::TaskErrorResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::TaskErrorResult do
  #let(:instance) { FactPulse::TaskErrorResult.new }

  describe 'test an instance of TaskErrorResult' do
    it 'should create an instance of TaskErrorResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::TaskErrorResult)
    end
  end
