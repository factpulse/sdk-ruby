...
# Unit tests for FactPulse::AFNORAddressRead
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORAddressRead do
  #let(:instance) { FactPulse::AFNORAddressRead.new }

  describe 'test an instance of AFNORAddressRead' do
    it 'should create an instance of AFNORAddressRead' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORAddressRead)
    end
  end
