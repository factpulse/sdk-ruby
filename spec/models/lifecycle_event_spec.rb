...
# Unit tests for FactPulse::LifecycleEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::LifecycleEvent do
  #let(:instance) { FactPulse::LifecycleEvent.new }

  describe 'test an instance of LifecycleEvent' do
    it 'should create an instance of LifecycleEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::LifecycleEvent)
    end
  end
  ...
  describe 'test attribute "issuer_siren"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "issuer_role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
