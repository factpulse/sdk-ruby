...
# Unit tests for FactPulse::AFNORFullFlowInfoExtension
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFullFlowInfoExtension do
  #let(:instance) { FactPulse::AFNORFullFlowInfoExtension.new }

  describe 'test an instance of AFNORFullFlowInfoExtension' do
    it 'should create an instance of AFNORFullFlowInfoExtension' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFullFlowInfoExtension)
    end
  end
