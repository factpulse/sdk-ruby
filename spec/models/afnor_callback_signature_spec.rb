...
# Unit tests for FactPulse::AFNORCallbackSignature
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORCallbackSignature do
  #let(:instance) { FactPulse::AFNORCallbackSignature.new }

  describe 'test an instance of AFNORCallbackSignature' do
    it 'should create an instance of AFNORCallbackSignature' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORCallbackSignature)
    end
  end

  describe 'test attribute "algo"' do
    it 'should work' do
