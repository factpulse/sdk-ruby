...
# Unit tests for FactPulse::SimplifiedCDARResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::SimplifiedCDARResponse do
  #let(:instance) { FactPulse::SimplifiedCDARResponse.new }

  describe 'test an instance of SimplifiedCDARResponse' do
    it 'should create an instance of SimplifiedCDARResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::SimplifiedCDARResponse)
    end
  end
