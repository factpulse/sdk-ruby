...
# Unit tests for FactPulse::AFNORWebhookParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORWebhookParams do
  #let(:instance) { FactPulse::AFNORWebhookParams.new }

  describe 'test an instance of AFNORWebhookParams' do
    it 'should create an instance of AFNORWebhookParams' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORWebhookParams)
    end
  end
