...
# Unit tests for FactPulse::FacturXInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::FacturXInvoice do
  #let(:instance) { FactPulse::FacturXInvoice.new }

  describe 'test an instance of FacturXInvoice' do
    it 'should create an instance of FacturXInvoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::FacturXInvoice)
    end
  end
