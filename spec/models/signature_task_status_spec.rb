...
# Unit tests for FactPulse::SignatureTaskStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::SignatureTaskStatus do
  #let(:instance) { FactPulse::SignatureTaskStatus.new }

  describe 'test an instance of SignatureTaskStatus' do
    it 'should create an instance of SignatureTaskStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::SignatureTaskStatus)
    end
  end
