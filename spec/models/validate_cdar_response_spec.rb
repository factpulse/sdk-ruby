...
# Unit tests for FactPulse::ValidateCDARResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ValidateCDARResponse do
  #let(:instance) { FactPulse::ValidateCDARResponse.new }

  describe 'test an instance of ValidateCDARResponse' do
    it 'should create an instance of ValidateCDARResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ValidateCDARResponse)
    end
  end
