...
# Unit tests for FactPulse::AFNORFlowProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORFlowProfile do
  #let(:instance) { FactPulse::AFNORFlowProfile.new }

  describe 'test an instance of AFNORFlowProfile' do
    it 'should create an instance of AFNORFlowProfile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORFlowProfile)
    end
  end
