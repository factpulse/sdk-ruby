...
# Unit tests for FactPulse::VerificationSuccessTaskResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::VerificationSuccessTaskResult do
  #let(:instance) { FactPulse::VerificationSuccessTaskResult.new }

  describe 'test an instance of VerificationSuccessTaskResult' do
    it 'should create an instance of VerificationSuccessTaskResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::VerificationSuccessTaskResult)
    end
  end
