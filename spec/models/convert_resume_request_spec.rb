...
# Unit tests for FactPulse::ConvertResumeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ConvertResumeRequest do
  #let(:instance) { FactPulse::ConvertResumeRequest.new }

  describe 'test an instance of ConvertResumeRequest' do
    it 'should create an instance of ConvertResumeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ConvertResumeRequest)
    end
  end
  ...
  describe 'test attribute "webhook_mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
