...
# Unit tests for FactPulse::ParseFacturXResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ParseFacturXResponse do
  #let(:instance) { FactPulse::ParseFacturXResponse.new }

  describe 'test an instance of ParseFacturXResponse' do
    it 'should create an instance of ParseFacturXResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ParseFacturXResponse)
    end
  end
  ...
  describe 'test attribute "detected_format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
