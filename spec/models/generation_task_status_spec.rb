...
# Unit tests for FactPulse::GenerationTaskStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::GenerationTaskStatus do
  #let(:instance) { FactPulse::GenerationTaskStatus.new }

  describe 'test an instance of GenerationTaskStatus' do
    it 'should create an instance of GenerationTaskStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::GenerationTaskStatus)
    end
  end
