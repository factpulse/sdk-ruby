...
# Unit tests for FactPulse::KeyRotationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::KeyRotationRequest do
  #let(:instance) { FactPulse::KeyRotationRequest.new }

  describe 'test an instance of KeyRotationRequest' do
    it 'should create an instance of KeyRotationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::KeyRotationRequest)
    end
  end
