...
# Unit tests for FactPulse::ValidationSuccessTaskResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ValidationSuccessTaskResult do
  #let(:instance) { FactPulse::ValidationSuccessTaskResult.new }

  describe 'test an instance of ValidationSuccessTaskResult' do
    it 'should create an instance of ValidationSuccessTaskResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ValidationSuccessTaskResult)
    end
  end
