...
# Unit tests for FactPulse::LineSubType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::LineSubType do
  #let(:instance) { FactPulse::LineSubType.new }

  describe 'test an instance of LineSubType' do
    it 'should create an instance of LineSubType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::LineSubType)
    end
  end
