...
# Unit tests for FactPulse::ChorusProResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ChorusProResult do
  #let(:instance) { FactPulse::ChorusProResult.new }

  describe 'test an instance of ChorusProResult' do
    it 'should create an instance of ChorusProResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ChorusProResult)
    end
  end
