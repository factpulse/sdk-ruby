...
# Unit tests for FactPulse::InvoiceLifecycle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::InvoiceLifecycle do
  #let(:instance) { FactPulse::InvoiceLifecycle.new }

  describe 'test an instance of InvoiceLifecycle' do
    it 'should create an instance of InvoiceLifecycle' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::InvoiceLifecycle)
    end
  end
