...
# Unit tests for FactPulse::VATEXCodesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::VATEXCodesResponse do
  #let(:instance) { FactPulse::VATEXCodesResponse.new }

  describe 'test an instance of VATEXCodesResponse' do
    it 'should create an instance of VATEXCodesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::VATEXCodesResponse)
    end
  end
