...
# Unit tests for FactPulse::IssuerRoleCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::IssuerRoleCode do
  #let(:instance) { FactPulse::IssuerRoleCode.new }

  describe 'test an instance of IssuerRoleCode' do
    it 'should create an instance of IssuerRoleCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::IssuerRoleCode)
    end
  end
