...
# Unit tests for FactPulse::ConversionExtractionInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::ConversionExtractionInfo do
  #let(:instance) { FactPulse::ConversionExtractionInfo.new }

  describe 'test an instance of ConversionExtractionInfo' do
    it 'should create an instance of ConversionExtractionInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::ConversionExtractionInfo)
    end
  end
  ...
  describe 'test attribute "ocr_provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
