...
# Unit tests for FactPulse::PaymentCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::PaymentCard do
  #let(:instance) { FactPulse::PaymentCard.new }

  describe 'test an instance of PaymentCard' do
    it 'should create an instance of PaymentCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::PaymentCard)
    end
  end
