...
# Unit tests for FactPulse::Recipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::Recipient do
  #let(:instance) { FactPulse::Recipient.new }

  describe 'test an instance of Recipient' do
    it 'should create an instance of Recipient' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::Recipient)
    end
  end
  ...
  describe 'test attribute "executing_service_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
