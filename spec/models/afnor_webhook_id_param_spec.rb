...
# Unit tests for FactPulse::AFNORWebhookIdParam
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORWebhookIdParam do
  #let(:instance) { FactPulse::AFNORWebhookIdParam.new }

  describe 'test an instance of AFNORWebhookIdParam' do
    it 'should create an instance of AFNORWebhookIdParam' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORWebhookIdParam)
    end
  end
