...
# Unit tests for FactPulse::AFNORSortingOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORSortingOrder do
  #let(:instance) { FactPulse::AFNORSortingOrder.new }

  describe 'test an instance of AFNORSortingOrder' do
    it 'should create an instance of AFNORSortingOrder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORSortingOrder)
    end
  end
