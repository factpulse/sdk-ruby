...
# Unit tests for FactPulse::AFNORWebhookPatchPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORWebhookPatchPayload do
  #let(:instance) { FactPulse::AFNORWebhookPatchPayload.new }

  describe 'test an instance of AFNORWebhookPatchPayload' do
    it 'should create an instance of AFNORWebhookPatchPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORWebhookPatchPayload)
    end
  end
