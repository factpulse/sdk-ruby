...
# Unit tests for FactPulse::TransmissionTypeCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::TransmissionTypeCode do
  #let(:instance) { FactPulse::TransmissionTypeCode.new }

  describe 'test an instance of TransmissionTypeCode' do
    it 'should create an instance of TransmissionTypeCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::TransmissionTypeCode)
    end
  end
