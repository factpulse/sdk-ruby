...
# Unit tests for FactPulse::AFNORWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::AFNORWebhook do
  #let(:instance) { FactPulse::AFNORWebhook.new }

  describe 'test an instance of AFNORWebhook' do
    it 'should create an instance of AFNORWebhook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::AFNORWebhook)
    end
  end
