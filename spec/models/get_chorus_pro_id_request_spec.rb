...
# Unit tests for FactPulse::GetChorusProIdRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FactPulse::GetChorusProIdRequest do
  #let(:instance) { FactPulse::GetChorusProIdRequest.new }

  describe 'test an instance of GetChorusProIdRequest' do
    it 'should create an instance of GetChorusProIdRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FactPulse::GetChorusProIdRequest)
    end
  end
