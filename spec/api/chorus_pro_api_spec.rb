...
# Unit tests for OpenapiClient::ChorusProApi
...
describe 'ChorusProApi' do
  ...
  describe 'test an instance of ChorusProApi' do
    it 'should create an instance of ChorusProApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::ChorusProApi)
    end
  end
  ...
  # @param id_structure_cpp Chorus Pro structure ID (idStructureCPP)
  # @param [Hash] opts the optional parameters
