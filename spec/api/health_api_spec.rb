...
# Unit tests for FactPulse::HealthApi
...
describe 'HealthApi' do
  ...
  describe 'test an instance of HealthApi' do
    it 'should create an instance of HealthApi' do
      expect(@api_instance).to be_instance_of(FactPulse::HealthApi)
    end
  end

  # unit tests for get_user_info_api_v1_me_get
  ...
  # @return [Object]
  describe 'get_user_info_api_v1_me_get test' do
    it 'should work' do
