...
# Unit tests for FactPulse::AFNORDirectoryServiceMtierApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AFNORDirectoryServiceMtierApi' do
  before do
  ...
  describe 'test an instance of AFNORDirectoryServiceMtierApi' do
    it 'should create an instance of AFNORDirectoryServiceMtierApi' do
      expect(@api_instance).to be_instance_of(FactPulse::AFNORDirectoryServiceMtierApi)
    end
  end

  # unit tests for get_siren_metier_api_v1_afnor_directory_siren_siren_get
  ...
  # @return [Object]
  describe 'get_siren_metier_api_v1_afnor_directory_siren_siren_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_siret_metier_api_v1_afnor_directory_siret_siret_get
  ...
  # @option opts [PDPCredentials] :pdp_credentials 
  # @return [Object]
  describe 'get_siret_metier_api_v1_afnor_directory_siret_siret_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for search_siren_metier_api_v1_afnor_directory_siren_search_post
  ...
  # @param body_search_siren_metier_api_v1_afnor_directory_siren_search_post 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'search_siren_metier_api_v1_afnor_directory_siren_search_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for search_siret_metier_api_v1_afnor_directory_siret_search_post
  ...
  # @param body_search_siret_metier_api_v1_afnor_directory_siret_search_post 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'search_siret_metier_api_v1_afnor_directory_siret_search_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
