...
# Unit tests for FactPulse::AsyncTasksApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AsyncTasksApi' do
  before do
  ...
  describe 'test an instance of AsyncTasksApi' do
    it 'should create an instance of AsyncTasksApi' do
      expect(@api_instance).to be_instance_of(FactPulse::AsyncTasksApi)
    end
  end

  # unit tests for get_generation_task_status_api_v1_processing_tasks_task_id_generation_status_get
  ...
  # @param task_id Celery task ID returned by /generate-invoice
  # @param [Hash] opts the optional parameters
  # @return [GenerationTaskStatus]
  describe 'get_generation_task_status_api_v1_processing_tasks_task_id_generation_status_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_signature_task_status_api_v1_processing_tasks_task_id_signature_status_get
  ...
  # @param task_id Celery task ID returned by /sign-pdf-async
  # @param [Hash] opts the optional parameters
  # @return [SignatureTaskStatus]
  describe 'get_signature_task_status_api_v1_processing_tasks_task_id_signature_status_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param task_id Celery task ID returned by async endpoints (UUID format)
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for get_validation_task_status_api_v1_processing_tasks_task_id_validation_status_get
  ...
  # @param task_id Celery task ID returned by /validate-pdf
  # @param [Hash] opts the optional parameters
  # @return [ValidationTaskStatus]
  describe 'get_validation_task_status_api_v1_processing_tasks_task_id_validation_status_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
