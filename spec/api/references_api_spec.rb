...
# Unit tests for FactPulse::ReferencesApi
...
describe 'ReferencesApi' do
  ...
  describe 'test an instance of ReferencesApi' do
    it 'should create an instance of ReferencesApi' do
      expect(@api_instance).to be_instance_of(FactPulse::ReferencesApi)
    end
  end

  # unit tests for get_vatex_codes_api_v1_references_vatex_codes_get
  ...
  describe 'get_vatex_codes_api_v1_references_vatex_codes_get test' do
    it 'should work' do
