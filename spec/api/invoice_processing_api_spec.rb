...
# Unit tests for FactPulse::InvoiceProcessingApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceProcessingApi' do
  before do
  ...
  describe 'test an instance of InvoiceProcessingApi' do
    it 'should create an instance of InvoiceProcessingApi' do
      expect(@api_instance).to be_instance_of(FactPulse::InvoiceProcessingApi)
    end
  end

  # unit tests for generate_invoice_api_v1_processing_generate_invoice_post
  ...
  # @param invoice_data Invoice data in JSON format.              Two formats accepted:             1. **Classic format**: Complete FactureFacturX structure (all fields)             2. **Simplified format** (🆕 P0.1): Minimal structure with auto-enrichment              Format is detected automatically!             
  ...
  # @option opts [Boolean] :auto_enrich 🆕 Enable auto-enrichment from SIRET/SIREN (simplified format only)
  # @option opts [File] :source_pdf 
  # @return [TaskResponse]
  describe 'generate_invoice_api_v1_processing_generate_invoice_post test' do
    it 'should work' do
  ...
  # unit tests for get_task_status_api_v1_processing_tasks_task_id_status_get
  ...
  describe 'get_task_status_api_v1_processing_tasks_task_id_status_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for submit_complete_invoice_api_v1_processing_invoices_submit_complete_post
  ...
  # @param submit_complete_invoice_request 
  # @param [Hash] opts the optional parameters
  # @return [SubmitCompleteInvoiceResponse]
  describe 'submit_complete_invoice_api_v1_processing_invoices_submit_complete_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for submit_complete_invoice_async_api_v1_processing_invoices_submit_complete_async_post
  ...
  # @param [Hash] opts the optional parameters
  # @return [TaskResponse]
  describe 'submit_complete_invoice_async_api_v1_processing_invoices_submit_complete_async_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for validate_facturx_pdf_api_v1_processing_validate_facturx_pdf_post
  ...
  # @param pdf_file Factur-X PDF file to validate (.pdf format).
  # @param [Hash] opts the optional parameters
  # @option opts [FacturXProfile] :profile 
  # @option opts [Boolean] :use_verapdf Enable strict PDF/A validation with VeraPDF (recommended for production). If False, uses basic metadata validation.
  # @return [PDFValidationResultAPI]
  describe 'validate_facturx_pdf_api_v1_processing_validate_facturx_pdf_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for validate_facturx_pdf_async_api_v1_processing_validate_facturx_async_post
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [FacturXProfile] :profile 
  # @option opts [Boolean] :use_verapdf Enable strict PDF/A validation with VeraPDF (recommended for production). May take several seconds.
  # @return [TaskResponse]
  describe 'validate_facturx_pdf_async_api_v1_processing_validate_facturx_async_post test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param xml_file Factur-X XML file to validate (.xml format).
  # @param [Hash] opts the optional parameters
  # @option opts [FacturXProfile] :profile Validation profile (MINIMUM, BASIC, EN16931, EXTENDED).
