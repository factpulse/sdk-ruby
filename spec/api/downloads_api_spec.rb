...
# Unit tests for OpenapiClient::DownloadsApi
...
describe 'DownloadsApi' do
  ...
  describe 'test an instance of DownloadsApi' do
    it 'should create an instance of DownloadsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::DownloadsApi)
    end
  end
  ...
  # unit tests for check_file_api_v1_download_download_id_head_0
  # Check if a file exists
  # Check if a temporary file exists and get its metadata without downloading.  Useful for: - Verifying a download URL is still valid - Getting file size before downloading - Checking expiration time  **Security**: Requires authentication, only file owner can check.
  # @param download_id 
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'check_file_api_v1_download_download_id_head_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for download_file_api_v1_download_download_id_get_0
  # Download a temporary file
  # Download a file stored temporarily after asynchronous processing.  **Usage**: - This URL is provided in webhook notifications when using &#x60;webhook_mode: \&quot;download_url\&quot;&#x60; - Files are automatically deleted after 1 hour - Each file can only be downloaded until it expires  **Security**: - Requires a valid JWT token - Only the user who initiated the task can download the file
  # @param download_id 
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :delete_after If true, delete the file after download (one-time download)
  # @return [Object]
  describe 'download_file_api_v1_download_download_id_get_0 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
