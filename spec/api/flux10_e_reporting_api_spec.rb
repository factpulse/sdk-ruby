...
# Unit tests for FactPulse::Flux10EReportingApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Flux10EReportingApi' do
  before do
  ...
  describe 'test an instance of Flux10EReportingApi' do
    it 'should create an instance of Flux10EReportingApi' do
      expect(@api_instance).to be_instance_of(FactPulse::Flux10EReportingApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :validate_coherence Validate data coherence (REJ_COH)
  # @option opts [Boolean] :validate_period Validate period coherence (REJ_PER)
  # @return [Hash<String, Object>]
